...
AI-native operating system for solo founders. One person. Five-person output.
...
- Plain text artifacts, no vendor lock-in
...
```bash
git clone https://github.com/BellaBe/strategy-os
cd strategy-os
claude
```
